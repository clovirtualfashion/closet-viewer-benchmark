...
export const testDataProvision: TestDataProvision = {
    liburl: new URL("https://viewer-library.s3.ap-northeast-2.amazonaws.com/closet.viewer-2345678.js"),
    zrestURLs: [
    ...
    heavy:"https://viewer-test-model.s3.ap-northeast-2.amazonaws.com/00000000.zrest",
}